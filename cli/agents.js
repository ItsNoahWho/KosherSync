...
// line has to earn the tokens — flags and examples stay in `ksync help <cmd>`,
...
\`ksync test <file.luau>\` starts a playtest, runs the file inside it, stops the
...
// How to work *on* KosherSync, as opposed to how to use it. Deliberately never
...
export const BEGIN = "<!-- begin koshersync -->";
export const END = "<!-- end koshersync -->";
...
export function renderSection(options) {
  ...
  return [BEGIN, "", "## KosherSync", body.trimEnd(), "", END, ""].join("\n");
}
